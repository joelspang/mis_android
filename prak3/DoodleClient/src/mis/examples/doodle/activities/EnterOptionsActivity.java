...
import mis.examples.doodle.net.CreatePollRequest;
...
public class EnterOptionsActivity extends Activity {
	...
	btnFinish.setOnClickListener(new View.OnClickListener() {
	    ...
	    @Override
	    public void onClick(View arg0) {
		// Send a POST request to the server to save the newly created
		// poll
	...
	public void onRequestSuccess(Poll responsePoll) {
	    ...
	    PollDataHelper helper = new PollDataHelper(
		    EnterOptionsActivity.this);
	    helper.addPoll(responsePoll);
