...
public class NewPollActivity extends Activity {
    ...
    SpiceManager spiceManager = new SpiceManager(
	...
	this.input_title = (String) getIntent().getSerializableExtra(
		"input_title");
	this.input_location = (String) getIntent().getSerializableExtra(
		"input_location");
	this.input_description = (String) getIntent().getSerializableExtra(
		"input_description");
	this.input_name = (String) getIntent().getSerializableExtra(
		"input_name");
	this.input_email = (String) getIntent().getSerializableExtra(
		"input_email");
	...
	btnNext.setOnClickListener(new View.OnClickListener() {
		...
		i.putExtra("input_description", txtDescription.getText()
			.toString());
	...
	((TextView) findViewById(R.id.txtNpLocation))
		.setText(this.input_location);
	((TextView) findViewById(R.id.txtNpDescription))
		.setText(this.input_description);
